			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins" style="margin-bottom:0px !important;border-bottom:0px !important;">
					...
					<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="旅游汽车公司名称" id="feature_name" class="form-control">
							</div>
                    ...
                    <div class="ibox-content" id="result">
						<div class="row">
							<div class="col-sm-12">
								<a href="/index.php/res/Resources/car_add" id="btnadd" class="btn btn-primary ">新增汽车公司</a>
						...
						<table class="table table-striped table-bordered table-hover display nowrap"  cellspacing="0" width="100%" id="editable">
							...
							<tbody>
								<tr>
									...
									<td>北京</td>
									<td>朝阳区王四营马房寺368号</td>
									<td>86-010-67635764</td>
									<td>伟景行</td>
									<td>2017-05-11 13:22:49</td>
									<td><a href="/index.php/res/Resources/car_look">查看</a> | <a href="/index.php/res/Resources/car_update">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a></td>
								</tr>
								<tr>
									<td>2</td>
									<td>北京天马旅游汽车有限公司</td>
								...
								<tr>
									<td>3</td>
									<td>北京首都旅游汽车集团股份有限公司</td>
									<td>北京</td>
									<td>朝阳区三里屯5号</td>
									<td>010-64616688-4003</td>
									<td>伟景行</td>
