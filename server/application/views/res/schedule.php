        ...
        <div class="row">
            <div class="col-sm-12">
				...
				<div class="ibox-content">
					<div id="schedule_table_wrapper" class="dataTables_wrapper form-inline" role="grid"><div class="row"><div class="col-sm-6"><a id="btn_add" href="/index.php/res/business/s_add" class="btn btn-primary">新建日程</a>   <a id="btn_delete" onclick="batch_delete()" class="btn btn-primary">批量删除</a><div class="dataTables_length" id="schedule_table_length" style="float: left;"><label>每页 <select name="schedule_table_length" aria-controls="schedule_table" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option></select> 条记录</label></div></div><div class="col-sm-6"></div></div><table class="table table-striped table-bordered table-hover display nowrap dataTable no-footer" cellspacing="0" width="100%" id="schedule_table" style="table-layout: fixed; width: 100%;" aria-describedby="schedule_table_info">
						<thead>
							<tr role="row"><th width="3%" rowspan="1" colspan="1" style="width: 15px;"><input type="checkbox" class="all_chk"></th><th width="5%" rowspan="1" colspan="1" style="width: 37px;">序号</th><th width="27%" rowspan="1" colspan="1" style="width: 279px;">日程主题</th><th width="10%" rowspan="1" colspan="1" style="width: 92px;">日程地点</th><th width="10%" rowspan="1" colspan="1" style="width: 92px;">日程类型</th><th width="10%" rowspan="1" colspan="1" style="width: 92px;">创建人</th><th width="10%" rowspan="1" colspan="1" style="width: 91px;">开始时间</th><th width="10%" rowspan="1" colspan="1" style="width: 91px;">结束时间</th><th width="15%" rowspan="1" colspan="1" style="width: 146px;">操作</th></tr>
						</thead>
					<tbody>
						<tr class="odd"><td class=" "><input type="checkbox" value="27"></td><td class=" ">1</td><td class=" ">周例会</td><td class=" ">北京</td><td class=" ">一般</td><td class=" ">沈浪</td><td class=" ">2017-05-04 14:58:44</td><td class=" ">2017-05-05 14:58:45</td><td class=" "><a href="/index.php/res/business/s_details/27">查看</a> | <a href="/index.php/res/business/s_edit/27">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a> </td></tr>
						<tr class=""><td class=" "><input type="checkbox" value="27"></td><td class=" ">2</td><td class=" ">周例会</td><td class=" ">北京</td><td class=" ">一般</td><td class=" ">李飞</td><td class=" ">2017-05-04 14:58:44</td><td class=" ">2017-05-05 14:58:45</td><td class=" "><a href="/index.php/res/business/s_details/27">查看</a> | <a href="/index.php/res/business/s_edit/27">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a> </td></tr>
						<tr class="odd"><td class=" "><input type="checkbox" value="27"></td><td class=" ">3</td><td class=" ">周例会</td><td class=" ">北京</td><td class=" ">一般</td><td class=" ">关严</td><td class=" ">2017-05-04 14:58:44</td><td class=" ">2017-05-05 14:58:45</td><td class=" "><a href="/index.php/res/business/s_details/27">查看</a> | <a href="/index.php/res/business/s_edit/27">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a> </td></tr>
						<tr class=""><td class=" "><input type="checkbox" value="27"></td><td class=" ">4</td><td class=" ">周例会</td><td class=" ">北京</td><td class=" ">一般</td><td class=" ">赵健</td><td class=" ">2017-05-04 14:58:44</td><td class=" ">2017-05-05 14:58:45</td><td class=" "><a href="/index.php/res/business/s_details/27">查看</a> | <a href="/index.php/res/business/s_edit/27">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a> </td></tr>
						<tr class="odd"><td class=" "><input type="checkbox" value="27"></td><td class=" ">5</td><td class=" ">周例会</td><td class=" ">北京</td><td class=" ">一般</td><td class=" ">黑子</td><td class=" ">2017-05-04 14:58:44</td><td class=" ">2017-05-05 14:58:45</td><td class=" "><a href="/index.php/res/business/s_details/27">查看</a> | <a href="/index.php/res/business/s_edit/27">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a> </td></tr>
