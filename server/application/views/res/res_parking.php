			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins" style="margin-bottom:0px !important;border-bottom:0px !important;">
					...
					<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="停车场名称" id="feature_name" class="form-control">
							</div>
                    ...
                    <div class="ibox-content" id="result">
						<div class="row">
							<div class="col-sm-12">
								<a href="/index.php/res/Resources/park_add" id="btnadd" class="btn btn-primary ">新增停车场</a>
						...
						<table class="table table-striped table-bordered table-hover display nowrap"  cellspacing="0" width="100%" id="editable">
							...
							<tbody>
								<tr>
									...
									<td>700</td>
									<td>澳门青松大厦</td>
									<td><a href="/index.php/res/Resources/park_look">查看</a> | <a href="/index.php/res/Resources/park_update">修改</a> | <a href="javascript:if(confirm('确定要删除吗?')) alert('删除成功')">删除</a></td>
								</tr>
								<tr>
									<td>2</td>
									<td>海景花园停车场</td>
