                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						...
						<div class="form-group">
							...
							<label class="col-sm-2 control-label">日程地点：</label>
							<div class="col-sm-3">
								<input type="text" name="schedule_address" class="form-control"  required>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3" style="padding-top:7px;">
								<input type="radio" name="schedule_status" value="紧急" required>紧急
								<input type="radio" name="schedule_status" value="一般" required>一般
							</div>
							<label class="col-sm-2 control-label">全天事件：</label>
							<div class="col-sm-3" style="padding-top:7px;">
							<input type="radio" name="is_all_day"  value="1" required>是
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea  name="schedule_content"  style="height:400px;" class="form-control" required></textarea>
							</div>
						</div>
