...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
		<a href="/index.php/res/prediction/public_economic" class="btn btn-primary pull-right">统计图</a>
	...
	<div class="ibox-content" id="result">
		...
		<div class="row">
			...
			<ul class="pagination">
				...
				<li class="paginate_button"><a href="#">66</a></li>
				<li class="paginate_button"><a href="#">67</a></li>
