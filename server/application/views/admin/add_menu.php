...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<form method="post" action="/index.php/admin/menu/add_menu" class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-2 control-label">上级菜单：</label>
				<div class="col-sm-3">
					<select class="form-control m-b" style="height:35px;" name="parentid">
			...
			<script type="text/javascript">
				...
				<div class="col-sm-3">
					<input type="text" name="color" id="color" style="width:280px;float:left;margin-right:10px" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                	<div class="radio">
                		<label><input type="radio" checked value="1" name="display">是</label>
                		<label><input type="radio" value="0" name="display">否</label>
                	</div>
                </div>
            </div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<a class="lcon"><img width="60px" height="60px" id="img" src="/statics/image/upload-pic.png"></a>
					<input type="hidden" name="img" id="imgurl" value="">
				</div>
			</div>
