        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
					...
					<form method="post"  id="form_info"  onsubmit="return dosubmit();"  action="/index.php/admin/emergency_route/update_emergency_route" class="form-horizontal" enctype="multipart/form-data">
                    <div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class="checkbox" name="spot_ids">
									...
									<button type="button" id="lookLine" class="small-button">查看路线</button>
								</div>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-8" id="introduce" title="<?php echo $spot_line_info['desc'];?>">
