                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="esu_name" class="form-control" required   value="<?php echo $esu_info['esu_name']; ?>">
							</div>
							<label class="col-sm-2 control-label">负责人：</label>
							<div class="col-sm-3">
								<input type="text" name="director" class="form-control" required   value="<?php echo $esu_info['director']; ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">座机号：</label>
							<div class="col-sm-3">
								<input type="text" name="telephone" class="form-control" required value="<?php echo $esu_info['telephone']; ?>">
							</div>
							<label class="col-sm-2 control-label">手机号：</label>
							<div class="col-sm-3">
								<input type="text" name="mobile" class="form-control" required value="<?php echo $esu_info['mobile']; ?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" name="address" class="form-control" required value="<?php echo $esu_info['address']; ?>">
							</div>

							<label class="col-sm-2 control-label">x坐标：</label>
							<div class="col-sm-3">
								<input type="text"  id="x_index"  name="x_index" class="form-control form-dw"  required value="<?php echo $esu_info['x_index']; ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text"  id="y_index"  name="y_index" class="form-control" required value="<?php echo $esu_info['y_index']; ?>">
							<img src="/statics/image/zom.png" class="to_enlarge">
							</div>

							<label class="col-sm-2 control-label">z坐标：</label>
							<div class="col-sm-3">
								<input type="text"  id="z_index"  name="z_index" class="form-control" required value="<?php echo $esu_info['z_index']; ?>">
							<img src="/statics/image/zom.png" class="to_enlarge">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-3">
								<input type="radio" name="status" value="0" <?php if($esu_info['status'] == 0):?>checked<?php endif; ?>/>禁用 
								<input type="radio" name="status" value="1" <?php if($esu_info['status'] == 1):?>checked<?php endif; ?>/>启用 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="esu_desc" class="form-control" name="esu_desc" required="" aria-required="true"><?php echo $esu_info['esu_desc']; ?></textarea>
							</div>
						</div>
						<br />
						...
						<div class="form-group" >
							<div class="col-sm-8 col-sm-offset-2">
								<input type="hidden" value="<?php echo $esu_info['esu_id'];?>" name="esu_id">
