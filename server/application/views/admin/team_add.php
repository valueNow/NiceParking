        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
					...
					<form method="post"  id="form_info"  onsubmit="return dosubmit();"  action="/index.php/admin/emergecy_team/add_team" class="form-horizontal" enctype="multipart/form-data">
                    <div class="ibox-content">
						<div class="form-group">
							<label class="col-sm-2 control-label">队伍名称：</label>
							<div class="col-sm-3">
								<input type="text" name="team_name" class="form-control" required   value="">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<select name="team_type" class="form-control"  id="team_type" style="width:100%;height:30px;line-height:30px;font-size:12px;"   required>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="team_desc" class="form-control" name="team_desc" required="" aria-required="true"></textarea>
							</div>
						</div>
						<br />
