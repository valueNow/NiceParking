					...
					<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="2017-06-29" id="operating" class="form-control">
							</div>
							<button class="btn btn-white" type="button" onclick='search()' style="margin:0" >查询</button>
							<button class="btn btn-white" type="button" onclick='export_excel()' style="margin:0" >导出Excel</button>
						</form>
					</div>
...
$(document).ready(function() {
   table= $('#editable').DataTable( {
	   //alert("第一次弹框");
        ...
        "ajax": {
            "url": "/index.php/admin/timeQuantumStatistics/index",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
				d.timeslot = $('#operating').val();
            }
        },
		//"order": [[ 1, "desc" ]],
	/*	"columnDefs": [
...
function export_excel(){
	window.location.href="/index.php/admin/timeQuantumStatistics/export_excel"
}
</script>
</body>
</html>