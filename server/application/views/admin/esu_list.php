		...
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins" style="margin-bottom:0px !important;border-bottom:0px !important;">
					...
					<div class="ibox-content" style="padding:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="应急机构名称" id="esu_name" class="form-control">
							</div>
							<div class="form-group">
...
$(document).ready(function() {
   table= $('#editable').DataTable( {
        ...
        "ajax": {
            "url": "/index.php/admin/emergecy_esu/index",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
				d.esu_name = $('#esu_name').val();
				if($('#status').val()!=''){
					d.status = $('#status').val();
				}
            }
		...
		"columnDefs": [
		 ...
		 "drawCallback": function( settings ) {
			...
			if($('#btnadd').length<=0){
				$('<a href="/index.php/admin/emergecy_esu/add_esu" id="btnadd" class="btn btn-primary ">新增应急机构</a>').insertBefore($('#editable_length'));
				//$('<a href="#" onclick="window.parent.fnAddModelInMap(\'/index.php/admin/emergecy_esu/add_esu\',\'POI\',\'/statics/image/poi/ATM.png\');" id="btnadd" class="btn btn-primary ">新增应急机构</a>').insertBefore($('#editable_length'));
			}
		}
    });
});
