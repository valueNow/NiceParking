...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<form method="post" action="/index.php/admin/spot_video_monitor/stype_add" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				<div class="col-sm-4 col-sm-offset-2">
					...
					<a href="/index.php/admin/spot_video_monitor/stype_index" class="btn btn-primary">返回列表</a>
				</div>
			</div>
		</form>
	</div>
