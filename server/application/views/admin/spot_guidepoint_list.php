					...
					<div class="ibox-content" style="padding-top:5px !important;padding-bottom:5px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="漫游点名称" id="point_name" class="form-control">
							</div>
...
$(document).ready(function() {
   table= $('#editable').DataTable( {
        ...
        "ajax": {
            "url": "/index.php/admin/spot_guide/point_index",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
				d.point_name = $('#point_name').val();
            }
        },
		"order": [[ 1, "desc" ]],
		"columnDefs": [
		 ...
		 "drawCallback": function( settings ) {
			...
			if($('#btnadd').length<=0){
				$('<a href="/index.php/admin/spot_guide/add_spot_guidepoint" id="btnadd" class="btn btn-primary ">新增漫游点</a>').insertBefore($('#editable_length'));
			}
		}
    });
});
