...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<form method="post" action="/index.php/admin/emergency/add_received" enctype="multipart/form-data" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="laydate-icon form-control layer-date" name="rec_time" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" required="">
				</div>
			</div>
			...
			<div class="form-group">
            	...
            	<div class="col-sm-3">
            		<input type="text" name="send_someone" class="form-control" required="">
            	</div>
            ...
            <div class="form-group">
            	...
            	<div class="col-sm-3">
            		<input type="text" name="receiver" class="form-control" required="" value="<?php echo $_SESSION['realname'];?>">
            	</div>
            </div>
			<div class="form-group">
