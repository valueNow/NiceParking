					...
					<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								业务:&nbsp;&nbsp;<input type="text" placeholder="业务查询" id="operating" class="form-control">
							</div>
							<div class="form-group">
								票名称查询:&nbsp;&nbsp;<input type="text" placeholder="票名称查询" id="username" class="form-control">
							</div>
							<div class="form-group">
								启用日期：<input  id="start_time" class="form-control layer-date" placeholder="YYYY-MM-DD" onclick="laydate({istime: true, format: 'YYYY-MM-DD'})" placeholder="开始时间">
...
$(document).ready(function() {
   table= $('#editable').DataTable( {
        ...
        "ajax": {
            "url": "/index.php/admin/singleTicketQuery/unused_ticket",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
				d.business = $('#operating').val();
				d.tic_name = $('#username').val();
				d.add_time = $('#start_time').val();
            }
        },
		"order": [[ 1, "desc" ]],
		"columnDefs": [
