        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
					...
					<form method="post"  id="form_info"  onsubmit="return dosubmit();"  action="/index.php/admin/emergency_safeguard/add_safeguard" class="form-horizontal" enctype="multipart/form-data">
