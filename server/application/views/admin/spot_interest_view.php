	...
	<div class="ibox-content">
		<form method="post" action="" enctype="multipart/form-data" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<?php echo $interest['spot_id'];?>
				</div>
				<label class="col-sm-2 control-label">兴趣点类型：</label>
				<div class="col-sm-3">
					<?php echo $interest['type_id'];?>
				</div>
			</div>
			...
			<div class="form-group">	
				...
				<div class="col-sm-3">
					<?php echo $interest['y_index'];?>
					<img src="/statics/image/zom.png" class="to_enlarge" onclick="sS()">
				</div>
				<label class="col-sm-2 control-label">z坐标：</label>
				<div class="col-sm-3">
					<?php echo $interest['z_index'];?>	
					<img src="/statics/image/zom.png" class="to_enlarge" onclick="sS()">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10" title="<?php echo $interest['desc'];?>" id="introduce">
					<?php echo $interest['desc'];?>
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
