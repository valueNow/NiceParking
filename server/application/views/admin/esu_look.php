                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<div class="form-group">
							...
							<div class="col-sm-3">
								<?php echo $esu_info['esu_name']; ?>
							</div>
							<label class="col-sm-2 control-label">负责人：</label>
							<div class="col-sm-3">
								<?php echo $esu_info['director']; ?>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">座机号：</label>
							<div class="col-sm-3">
								<?php echo $esu_info['telephone']; ?>
							</div>
							<label class="col-sm-2 control-label">手机号：</label>
							<div class="col-sm-3">
								<?php echo $esu_info['mobile']; ?>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<?php echo $esu_info['address']; ?>
							</div>
							<label class="col-sm-2 control-label">x坐标：</label>
                            	<div class="col-sm-3">
                            		<?php echo $esu_info['x_index']; ?>
                            		<input type="hidden" value="<?php echo $esu_info['x_index']; ?>" id="x_index" />
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<?php echo $esu_info['y_index']; ?>
								<input type="hidden" value="<?php echo $esu_info['y_index']; ?>" id="y_index" />
									<img src="/statics/image/zom.png" class="to_enlarge">
							</div>
							<label class="col-sm-2 control-label">z坐标：</label>
                            	<div class="col-sm-3">
                            		<input type="hidden" value="<?php echo $esu_info['z_index']; ?>" id="z_index" />
                            		<?php echo $esu_info['z_index']; ?>
                            			<img src="/statics/image/zom.png" class="to_enlarge">
                            	</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">	 
								<?php if($esu_info['status'] == 0): ?>禁用<?php else: ?>启用<?php endif; ?>
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-2 control-label">简介：</label>
							<div class="col-sm-8" id="introduce" title="<?php echo $esu_info['esu_desc']; ?>">
								<?php echo $esu_info['esu_desc']; ?>
							</div>
						</div>
						<br />
