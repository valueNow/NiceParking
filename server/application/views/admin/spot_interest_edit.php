...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<form method="post" action="/index.php/admin/spot_interest/interest_edit" enctype="multipart/form-data" class="form-horizontal">
				...
				<div class="col-sm-3">
					<select class="form-control m-b" style="height:35px;width:250px;" name="spot_id" required=''>
						...
						<?php foreach($spot as $k=>$v){?>
							<option value="<?php echo $k;?>" <?php echo  $interest['spot_id']==$k?"selected":"";?> ><?php echo $v;?></option>
						<?php }?>
					</select>
				</div>
				...
				<div class="col-sm-3">
					<select class="form-control m-b" style="height:35px;width:250px;" name="type_id" required=''>
						...
						<?php foreach($type as $key=>$val){?>
							<option value="<?php echo $key;?>" <?php echo  $interest['type_id']==$key?"selected":"";?> ><?php echo $val;?></option>
						<?php }?>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="interest_name" class="form-control" value="<?php echo $interest['interest_name'];?>" required="">
				</div>
				<label class="col-sm-2 control-label">x坐标：</label>
				<div class="col-sm-3">
					<input type="text" name="x_index" id="x_index" class="form-control" value="<?php echo $interest['x_index'];?>" required="">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="y_index" id="y_index" class="form-control" value="<?php echo $interest['y_index'];?>" required="">
					<img src="/statics/image/zom.png" class="to_enlarge" onclick="sS()">
				</div>
				<label class="col-sm-2 control-label">z坐标：</label>
				<div class="col-sm-3">
					<input type="text" name="z_index" id="z_index" class="form-control" value="<?php echo $interest['z_index'];?>" required="">
					<img src="/statics/image/zom.png" class="to_enlarge" onclick="sS()">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="address" class="form-control" value="<?php echo $interest['address'];?>" required="">
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea name="desc" style="height:100px;width:100%;" required class="form-control"><?php echo $interest['desc'];?></textarea>
				</div>
			</div>
			<div class="hr-line-dashed"></div>
			<div class="form-group">
