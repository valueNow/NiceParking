...
$(document).ready(function() {
   table= $('#editable').DataTable( {
        ...
        "ajax": {
            "url": "/index.php/admin/emergency/emergency_route",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
		...
		"columnDefs": [
		 ...
		 "drawCallback": function( settings ) {
			...
			if($('#btnadd').length<=0){
				$('<a href="/index.php/admin/emergency/add_emergency_route" id="btnadd" class="btn btn-primary ">新增应急游览路线</a>').insertBefore($('#editable_length'));
			}
		}
    });
});
