...
<div class="ibox float-e-margins">
	...
	<div class="ibox-content">
		<form method="post" action="/index.php/admin/spot_interest/stype_edit" enctype="multipart/form-data" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					...
					<?php if(!empty($type['img_id'])){?><a href="/<?php echo $type['img_id'];?>" target="_blank">点击查看原图</a><?php }?>
				</div>
			</div>
