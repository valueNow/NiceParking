					...
					<div class="ibox-content" style="padding-top:15px !important;padding-bottom:15px !important;"  id="quary">
						<form role="form" class="form-inline">
							<div class="form-group">
								<input type="text" placeholder="起始号" id="operating" class="form-control">
							</div>
							<div class="form-group">
								<input type="text" placeholder="结束号" id="username" class="form-control">
							</div>
...
$(document).ready(function() {
   table= $('#editable').DataTable( {
        ...
        "ajax": {
            "url": "/index.php/admin/singleTicketQuery/between_index",
			"data": function ( d ) {  
                //添加额外的参数传给服务器
				d.startNumber = $('#operating').val();
				d.endNumber = $('#username').val();
            }
        },
		"order": [[ 1, "desc" ]],
		"columnDefs": [
