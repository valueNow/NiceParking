        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
					...
					<form method="post"  id="form_info"  onsubmit="return dosubmit();"  action="/index.php/admin/spot_line/add_spot_line" class="form-horizontal" enctype="multipart/form-data">
                    <div class="ibox-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">	
								...
								<p><input type="button" id="createLine" onclick="__jingweidufreeLine();"  class="small-button" value="创建路线">
								<input type="button" id="modifyLine"  style="display: none;" onclick="__jingweidufreeLine();" value="修改路线">
								&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button type="button" id="lookLine"  class="small-button">预览</button></p>
