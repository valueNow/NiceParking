...
public class Location_Activity extends CheckPermissionsActivity
	...
	private void initView(){
		rgLocationMode = findViewById(R.id.rg_locationMode);
		
		etInterval = findViewById(R.id.et_interval);
		etHttpTimeout = findViewById(R.id.et_httpTimeout);
		
		cbOnceLocation = findViewById(R.id.cb_onceLocation);
		cbGpsFirst = findViewById(R.id.cb_gpsFirst);
		cbAddress = findViewById(R.id.cb_needAddress);
		cbCacheAble = findViewById(R.id.cb_cacheAble);
		cbOnceLastest = findViewById(R.id.cb_onceLastest);
		cbSensorAble = findViewById(R.id.cb_sensorAble);

		tvResult = findViewById(R.id.tv_result);
		btLocation = findViewById(R.id.bt_location);

		rgGeoLanguage = findViewById(R.id.rg_language);
